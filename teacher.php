    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div id="add_class_form">
          ...
          <input class="form-control" name="code" placeholder="Code , Eg : BCSE-547">
          ...
          <input class="form-control" name="start" placeholder="Starting Roll Number (Eg. 100/AB/21)">
          <input class="form-control" name="end" placeholder="Ending Roll Number (Eg. 120/AB/21)">
